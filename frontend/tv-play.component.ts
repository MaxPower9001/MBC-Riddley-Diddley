...
@Component({
	...
	template: `
	  ...
	  <!--</div>-->
		...
		<h1 id="infoSection" class="warning {{infoSectionBackgroundColor}}">Das Spiel geht los!</h1>
...
export class TvPlayComponent implements OnInit {
    ...
    aktion: AktionsTyp;
    id: any;
    infoSectionBackgroundColor: string;
    ...
    ngOnInit() {
        let that = this;
        this.infoSectionBackgroundColor = 'alert-warning';
        ...
        this.missionControlService.ungueltigeAktionOderTimeout$.subscribe(function (ungueltigeAktionOderTimeout: UngueltigeAktionOderTimeout) {
            ...
            that.showInfo(ungueltigeAktionOderTimeout.spieler + " hat Mist gebaut und ein Leben verloren!");
        });
        ...
        this.missionControlService.spielVerloren$.subscribe(function (spielVerloren: SpielVerloren) {
            ...
            that.showInfo(spielVerloren.spieler + "ist sowas von raus!");
        });
    ...
    showInfo(message: string) {
        this.infoSectionBackgroundColor = this.infoSectionBackgroundColor === 'alert-danger' ? 'alert-warning': 'alert-danger';
        document.getElementById("infoSection").innerHTML = message;
    }
